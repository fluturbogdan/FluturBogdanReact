...
class AddPatient extends Component {
    ...
    _addPatient() {
        ...
        let serverUrl='http://192.168.0.103:3000';
        setTimeout(()=>{
            fetch(serverUrl+'/AddPatient?firstname=' + firstname +
                            '&lastname=' + lastname +
                            '&email=' + email +
                            '&age=' + age +
                            '&phone=' + phone +
                ...
                .then((responseJson) => {
                    if (responseJson.valid ==1) {
                        ...
                        ToastAndroid.show('Patient added with successfull...', ToastAndroid.SHORT);
                    }
                    else {
                        this.setState({
                            visible:!this.state.visible
                        });
                        ToastAndroid.show('Patient already exist...', ToastAndroid.SHORT);
                    }
                })
        },2000);
    }
